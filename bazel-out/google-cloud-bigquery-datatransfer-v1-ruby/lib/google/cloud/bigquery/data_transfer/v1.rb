  ...
  module Cloud
    module Bigquery
      module DataTransfer
        ...
        # 3. [Enable the BigQuery Data Transfer API.](https://console.cloud.google.com/apis/library/datatransfer.googleapis.com)
        ...
        #
        # [Product Documentation]: https://cloud.google.com/datatransfer
        #
        # ## Enabling Logging
        #
