...
namespace Google.Cloud.Dataproc.V1Beta2 {
  ...
  public static partial class WorkflowTemplateService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_CreateWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.CreateWorkflowTemplateRequest, global::Google.Cloud.Dataproc.V1Beta2.WorkflowTemplate>(serviceImpl.CreateWorkflowTemplate));
      serviceBinder.AddMethod(__Method_GetWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.GetWorkflowTemplateRequest, global::Google.Cloud.Dataproc.V1Beta2.WorkflowTemplate>(serviceImpl.GetWorkflowTemplate));
      serviceBinder.AddMethod(__Method_InstantiateWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.InstantiateWorkflowTemplateRequest, global::Google.LongRunning.Operation>(serviceImpl.InstantiateWorkflowTemplate));
      serviceBinder.AddMethod(__Method_InstantiateInlineWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.InstantiateInlineWorkflowTemplateRequest, global::Google.LongRunning.Operation>(serviceImpl.InstantiateInlineWorkflowTemplate));
      serviceBinder.AddMethod(__Method_UpdateWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.UpdateWorkflowTemplateRequest, global::Google.Cloud.Dataproc.V1Beta2.WorkflowTemplate>(serviceImpl.UpdateWorkflowTemplate));
      serviceBinder.AddMethod(__Method_ListWorkflowTemplates, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.ListWorkflowTemplatesRequest, global::Google.Cloud.Dataproc.V1Beta2.ListWorkflowTemplatesResponse>(serviceImpl.ListWorkflowTemplates));
      serviceBinder.AddMethod(__Method_DeleteWorkflowTemplate, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Cloud.Dataproc.V1Beta2.DeleteWorkflowTemplateRequest, global::Google.Protobuf.WellKnownTypes.Empty>(serviceImpl.DeleteWorkflowTemplate));
    }
