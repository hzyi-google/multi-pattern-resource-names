...
namespace Google.Cloud.Talent.V4Beta1 {
  ...
  public static partial class CompanyService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_CreateCompany, serviceImpl.CreateCompany);
      serviceBinder.AddMethod(__Method_GetCompany, serviceImpl.GetCompany);
      serviceBinder.AddMethod(__Method_UpdateCompany, serviceImpl.UpdateCompany);
      serviceBinder.AddMethod(__Method_DeleteCompany, serviceImpl.DeleteCompany);
      serviceBinder.AddMethod(__Method_ListCompanies, serviceImpl.ListCompanies);
    }
