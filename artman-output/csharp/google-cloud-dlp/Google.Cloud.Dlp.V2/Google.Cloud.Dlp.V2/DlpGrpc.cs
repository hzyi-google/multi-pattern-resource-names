...
namespace Google.Cloud.Dlp.V2 {
  ...
  public static partial class DlpService
  {
    ...
    {
      serviceBinder.AddMethod(__Method_InspectContent, serviceImpl.InspectContent);
      serviceBinder.AddMethod(__Method_RedactImage, serviceImpl.RedactImage);
      serviceBinder.AddMethod(__Method_DeidentifyContent, serviceImpl.DeidentifyContent);
      serviceBinder.AddMethod(__Method_ReidentifyContent, serviceImpl.ReidentifyContent);
      serviceBinder.AddMethod(__Method_ListInfoTypes, serviceImpl.ListInfoTypes);
      serviceBinder.AddMethod(__Method_CreateInspectTemplate, serviceImpl.CreateInspectTemplate);
      serviceBinder.AddMethod(__Method_UpdateInspectTemplate, serviceImpl.UpdateInspectTemplate);
      serviceBinder.AddMethod(__Method_GetInspectTemplate, serviceImpl.GetInspectTemplate);
      serviceBinder.AddMethod(__Method_ListInspectTemplates, serviceImpl.ListInspectTemplates);
      serviceBinder.AddMethod(__Method_DeleteInspectTemplate, serviceImpl.DeleteInspectTemplate);
      serviceBinder.AddMethod(__Method_CreateDeidentifyTemplate, serviceImpl.CreateDeidentifyTemplate);
      serviceBinder.AddMethod(__Method_UpdateDeidentifyTemplate, serviceImpl.UpdateDeidentifyTemplate);
      serviceBinder.AddMethod(__Method_GetDeidentifyTemplate, serviceImpl.GetDeidentifyTemplate);
      serviceBinder.AddMethod(__Method_ListDeidentifyTemplates, serviceImpl.ListDeidentifyTemplates);
      serviceBinder.AddMethod(__Method_DeleteDeidentifyTemplate, serviceImpl.DeleteDeidentifyTemplate);
      serviceBinder.AddMethod(__Method_CreateJobTrigger, serviceImpl.CreateJobTrigger);
      serviceBinder.AddMethod(__Method_UpdateJobTrigger, serviceImpl.UpdateJobTrigger);
      serviceBinder.AddMethod(__Method_HybridInspectJobTrigger, serviceImpl.HybridInspectJobTrigger);
      serviceBinder.AddMethod(__Method_GetJobTrigger, serviceImpl.GetJobTrigger);
      serviceBinder.AddMethod(__Method_ListJobTriggers, serviceImpl.ListJobTriggers);
      serviceBinder.AddMethod(__Method_DeleteJobTrigger, serviceImpl.DeleteJobTrigger);
      serviceBinder.AddMethod(__Method_ActivateJobTrigger, serviceImpl.ActivateJobTrigger);
      serviceBinder.AddMethod(__Method_CreateDlpJob, serviceImpl.CreateDlpJob);
      serviceBinder.AddMethod(__Method_ListDlpJobs, serviceImpl.ListDlpJobs);
      serviceBinder.AddMethod(__Method_GetDlpJob, serviceImpl.GetDlpJob);
      serviceBinder.AddMethod(__Method_DeleteDlpJob, serviceImpl.DeleteDlpJob);
      serviceBinder.AddMethod(__Method_CancelDlpJob, serviceImpl.CancelDlpJob);
      serviceBinder.AddMethod(__Method_CreateStoredInfoType, serviceImpl.CreateStoredInfoType);
      serviceBinder.AddMethod(__Method_UpdateStoredInfoType, serviceImpl.UpdateStoredInfoType);
      serviceBinder.AddMethod(__Method_GetStoredInfoType, serviceImpl.GetStoredInfoType);
      serviceBinder.AddMethod(__Method_ListStoredInfoTypes, serviceImpl.ListStoredInfoTypes);
      serviceBinder.AddMethod(__Method_DeleteStoredInfoType, serviceImpl.DeleteStoredInfoType);
      serviceBinder.AddMethod(__Method_HybridInspectDlpJob, serviceImpl.HybridInspectDlpJob);
      serviceBinder.AddMethod(__Method_FinishDlpJob, serviceImpl.FinishDlpJob);
    }
