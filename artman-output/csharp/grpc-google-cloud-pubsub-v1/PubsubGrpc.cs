...
namespace Google.Cloud.PubSub.V1 {
  ...
  public static partial class Publisher
  {
    ...
    {
      serviceBinder.AddMethod(__Method_CreateTopic, serviceImpl.CreateTopic);
      serviceBinder.AddMethod(__Method_UpdateTopic, serviceImpl.UpdateTopic);
      serviceBinder.AddMethod(__Method_Publish, serviceImpl.Publish);
      serviceBinder.AddMethod(__Method_GetTopic, serviceImpl.GetTopic);
      serviceBinder.AddMethod(__Method_ListTopics, serviceImpl.ListTopics);
      serviceBinder.AddMethod(__Method_ListTopicSubscriptions, serviceImpl.ListTopicSubscriptions);
      serviceBinder.AddMethod(__Method_ListTopicSnapshots, serviceImpl.ListTopicSnapshots);
      serviceBinder.AddMethod(__Method_DeleteTopic, serviceImpl.DeleteTopic);
    }
  ...
  public static partial class Subscriber
  {
    ...
    {
      serviceBinder.AddMethod(__Method_CreateSubscription, serviceImpl.CreateSubscription);
      serviceBinder.AddMethod(__Method_GetSubscription, serviceImpl.GetSubscription);
      serviceBinder.AddMethod(__Method_UpdateSubscription, serviceImpl.UpdateSubscription);
      serviceBinder.AddMethod(__Method_ListSubscriptions, serviceImpl.ListSubscriptions);
      serviceBinder.AddMethod(__Method_DeleteSubscription, serviceImpl.DeleteSubscription);
      serviceBinder.AddMethod(__Method_ModifyAckDeadline, serviceImpl.ModifyAckDeadline);
      serviceBinder.AddMethod(__Method_Acknowledge, serviceImpl.Acknowledge);
      serviceBinder.AddMethod(__Method_Pull, serviceImpl.Pull);
      serviceBinder.AddMethod(__Method_StreamingPull, serviceImpl.StreamingPull);
      serviceBinder.AddMethod(__Method_ModifyPushConfig, serviceImpl.ModifyPushConfig);
      serviceBinder.AddMethod(__Method_GetSnapshot, serviceImpl.GetSnapshot);
      serviceBinder.AddMethod(__Method_ListSnapshots, serviceImpl.ListSnapshots);
      serviceBinder.AddMethod(__Method_CreateSnapshot, serviceImpl.CreateSnapshot);
      serviceBinder.AddMethod(__Method_UpdateSnapshot, serviceImpl.UpdateSnapshot);
      serviceBinder.AddMethod(__Method_DeleteSnapshot, serviceImpl.DeleteSnapshot);
      serviceBinder.AddMethod(__Method_Seek, serviceImpl.Seek);
    }
