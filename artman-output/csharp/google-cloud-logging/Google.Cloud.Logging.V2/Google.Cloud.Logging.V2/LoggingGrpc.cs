...
namespace Google.Cloud.Logging.V2 {
  ...
  public static partial class LoggingServiceV2
  {
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, LoggingServiceV2Base serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_WriteLogEntries, serviceImpl.WriteLogEntries);
      serviceBinder.AddMethod(__Method_ListLogEntries, serviceImpl.ListLogEntries);
      serviceBinder.AddMethod(__Method_ListMonitoredResourceDescriptors, serviceImpl.ListMonitoredResourceDescriptors);
