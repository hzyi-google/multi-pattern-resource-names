...
namespace Google.Cloud.Logging.V2 {
  ...
  public static partial class ConfigServiceV2
  {
    ...
    {
      serviceBinder.AddMethod(__Method_ListBuckets, serviceImpl.ListBuckets);
      serviceBinder.AddMethod(__Method_GetBucket, serviceImpl.GetBucket);
      serviceBinder.AddMethod(__Method_UpdateBucket, serviceImpl.UpdateBucket);
      serviceBinder.AddMethod(__Method_ListSinks, serviceImpl.ListSinks);
      serviceBinder.AddMethod(__Method_GetSink, serviceImpl.GetSink);
      serviceBinder.AddMethod(__Method_CreateSink, serviceImpl.CreateSink);
      serviceBinder.AddMethod(__Method_UpdateSink, serviceImpl.UpdateSink);
      serviceBinder.AddMethod(__Method_DeleteSink, serviceImpl.DeleteSink);
      serviceBinder.AddMethod(__Method_ListExclusions, serviceImpl.ListExclusions);
      serviceBinder.AddMethod(__Method_GetExclusion, serviceImpl.GetExclusion);
      serviceBinder.AddMethod(__Method_CreateExclusion, serviceImpl.CreateExclusion);
      serviceBinder.AddMethod(__Method_UpdateExclusion, serviceImpl.UpdateExclusion);
      serviceBinder.AddMethod(__Method_DeleteExclusion, serviceImpl.DeleteExclusion);
      serviceBinder.AddMethod(__Method_GetCmekSettings, serviceImpl.GetCmekSettings);
      serviceBinder.AddMethod(__Method_UpdateCmekSettings, serviceImpl.UpdateCmekSettings);
    }
