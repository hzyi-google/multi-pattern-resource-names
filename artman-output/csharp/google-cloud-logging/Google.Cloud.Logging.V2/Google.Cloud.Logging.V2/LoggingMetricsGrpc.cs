...
namespace Google.Cloud.Logging.V2 {
  ...
  public static partial class MetricsServiceV2
  {
    ...
    {
      serviceBinder.AddMethod(__Method_ListLogMetrics, serviceImpl.ListLogMetrics);
      serviceBinder.AddMethod(__Method_GetLogMetric, serviceImpl.GetLogMetric);
      serviceBinder.AddMethod(__Method_CreateLogMetric, serviceImpl.CreateLogMetric);
      serviceBinder.AddMethod(__Method_UpdateLogMetric, serviceImpl.UpdateLogMetric);
      serviceBinder.AddMethod(__Method_DeleteLogMetric, serviceImpl.DeleteLogMetric);
    }
