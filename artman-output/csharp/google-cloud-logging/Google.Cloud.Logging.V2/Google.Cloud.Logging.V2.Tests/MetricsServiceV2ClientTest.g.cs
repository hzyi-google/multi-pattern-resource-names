...
namespace Google.Cloud.Logging.V2.Tests
{
    ...
    public class GeneratedMetricsServiceV2ClientTest
    {
        ...
        public void GetLogMetric()
        {
            ...
            {
                MetricNameAsLogMetricName = new LogMetricName("[PROJECT]", "[METRIC]"),
            };
            LogMetric expectedResponse = new LogMetric
            {
                LogMetricName = new LogMetricName("[PROJECT]", "[METRIC]"),
            ...
            LogMetricName metricName = new LogMetricName("[PROJECT]", "[METRIC]");
