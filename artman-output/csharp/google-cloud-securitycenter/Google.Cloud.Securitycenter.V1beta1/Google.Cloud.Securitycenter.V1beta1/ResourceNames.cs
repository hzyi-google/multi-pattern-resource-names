...
namespace Google.Cloud.Securitycenter.V1beta1
{
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Securitycenter.V1beta1.SourceName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public Google.Cloud.Securitycenter.V1beta1.SourceName ParentAsSourceName
        {
            get { return string.IsNullOrEmpty(Parent) ? null : Google.Cloud.Securitycenter.V1beta1.SourceName.Parse(Parent); }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Securitycenter.V1beta1.OrganizationName"/>-typed view over the <see cref="Parent"/> resource name property.
        /// </summary>
        public Google.Cloud.Securitycenter.V1beta1.OrganizationName ParentAsOrganizationName
        {
            get { return string.IsNullOrEmpty(Parent) ? null : Google.Cloud.Securitycenter.V1beta1.OrganizationName.Parse(Parent); }
            set { Parent = value != null ? value.ToString() : ""; }
        }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Securitycenter.V1beta1.OrganizationSettingsName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public Google.Cloud.Securitycenter.V1beta1.OrganizationSettingsName OrganizationSettingsName
        {
            get { return string.IsNullOrEmpty(Name) ? null : Google.Cloud.Securitycenter.V1beta1.OrganizationSettingsName.Parse(Name); }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Securitycenter.V1beta1.SourceName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public Google.Cloud.Securitycenter.V1beta1.SourceName SourceName
        {
            get { return string.IsNullOrEmpty(Name) ? null : Google.Cloud.Securitycenter.V1beta1.SourceName.Parse(Name); }
            set { Name = value != null ? value.ToString() : ""; }
        }
    ...
    {
        /// <summary>
        /// <see cref="Google.Cloud.Securitycenter.V1beta1.FindingName"/>-typed view over the <see cref="Name"/> resource name property.
        /// </summary>
        public Google.Cloud.Securitycenter.V1beta1.FindingName FindingName
        {
            get { return string.IsNullOrEmpty(Name) ? null : Google.Cloud.Securitycenter.V1beta1.FindingName.Parse(Name); }
            set { Name = value != null ? value.ToString() : ""; }
        }
