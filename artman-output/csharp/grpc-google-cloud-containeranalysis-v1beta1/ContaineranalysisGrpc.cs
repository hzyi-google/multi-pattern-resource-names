...
namespace Google.Devtools.Containeranalysis.V1Beta1 {
  ...
  public static partial class ContainerAnalysisV1Beta1
  {
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, ContainerAnalysisV1Beta1Base serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_GetScanConfig, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Devtools.Containeranalysis.V1Beta1.GetScanConfigRequest, global::Google.Devtools.Containeranalysis.V1Beta1.ScanConfig>(serviceImpl.GetScanConfig));
      serviceBinder.AddMethod(__Method_ListScanConfigs, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Devtools.Containeranalysis.V1Beta1.ListScanConfigsRequest, global::Google.Devtools.Containeranalysis.V1Beta1.ListScanConfigsResponse>(serviceImpl.ListScanConfigs));
      serviceBinder.AddMethod(__Method_UpdateScanConfig, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Google.Devtools.Containeranalysis.V1Beta1.UpdateScanConfigRequest, global::Google.Devtools.Containeranalysis.V1Beta1.ScanConfig>(serviceImpl.UpdateScanConfig));
    }
