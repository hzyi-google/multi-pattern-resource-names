...
namespace Grafeas.V1Beta1 {
  ...
  public static partial class GrafeasV1Beta1
  {
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GrafeasV1Beta1Base serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_BatchCreateOccurrences, serviceImpl.BatchCreateOccurrences);
      ...
      serviceBinder.AddMethod(__Method_BatchCreateNotes, serviceImpl.BatchCreateNotes);
      ...
      serviceBinder.AddMethod(__Method_GetVulnerabilityOccurrencesSummary, serviceImpl.GetVulnerabilityOccurrencesSummary);
    }
