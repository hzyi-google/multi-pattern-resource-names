...
final class SetFindingStateRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.securitycenter.v1beta1.Finding.State state = 2;</code>
     */
    private $state = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Securitycenter\V1beta1\Finding_State::class);
        $this->state = $var;
