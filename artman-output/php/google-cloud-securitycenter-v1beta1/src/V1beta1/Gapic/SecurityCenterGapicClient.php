...
use Google\Cloud\Securitycenter\V1beta1\SecurityCenterGrpcClient;
...
class SecurityCenterGapicClient
{
    ...
    {
        if (self::$assetSecurityMarksNameTemplate == null) {
    ...
    {
        if (self::$findingSecurityMarksNameTemplate == null) {
