...
use Google\Cloud\Dataproc\V1beta2\InstantiateWorkflowTemplateRequest\ParametersEntry;
...
use Google\Cloud\Dataproc\V1beta2\WorkflowTemplateServiceGrpcClient;
