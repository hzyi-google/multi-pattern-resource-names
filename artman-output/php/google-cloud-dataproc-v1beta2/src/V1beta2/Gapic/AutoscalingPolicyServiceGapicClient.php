 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/dataproc/v1beta2/autoscaling_policies.proto
...
use Google\Cloud\Dataproc\V1beta2\AutoscalingPolicyServiceGrpcClient;
use Google\Cloud\Dataproc\V1beta2\CreateAutoscalingPolicyRequest;
use Google\Cloud\Dataproc\V1beta2\DeleteAutoscalingPolicyRequest;
use Google\Cloud\Dataproc\V1beta2\GetAutoscalingPolicyRequest;
use Google\Cloud\Dataproc\V1beta2\ListAutoscalingPoliciesRequest;
use Google\Cloud\Dataproc\V1beta2\ListAutoscalingPoliciesResponse;
use Google\Cloud\Dataproc\V1beta2\UpdateAutoscalingPolicyRequest;
...
class AutoscalingPolicyServiceGapicClient
{
     ...
     */
    const SERVICE_NAME = 'google.cloud.dataproc.v1beta2.AutoscalingPolicyService';
