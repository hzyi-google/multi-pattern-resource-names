...
use Google\Devtools\Containeranalysis\V1alpha1\ContainerAnalysisGrpcClient;
...
use Google\Devtools\Containeranalysis\V1alpha1\CreateOperationRequest;
...
use Google\Devtools\Containeranalysis\V1alpha1\GetScanConfigRequest;
...
use Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsRequest;
use Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsResponse;
use Google\Devtools\Containeranalysis\V1alpha1\Note;
use Google\Devtools\Containeranalysis\V1alpha1\Occurrence;
use Google\Devtools\Containeranalysis\V1alpha1\ScanConfig;
...
use Google\Devtools\Containeranalysis\V1alpha1\UpdateOperationRequest;
use Google\Devtools\Containeranalysis\V1alpha1\UpdateScanConfigRequest;
...
class ContainerAnalysisClientTest extends GeneratedTest
{
     ...
     * @test
     */
    public function createOperationTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        $response = $client->createOperation();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/CreateOperation', $actualFuncCall);
     ...
     * @test
     */
    public function createOperationExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
     ...
     * @test
     */
    public function updateOperationTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
        ...
        $response = $client->updateOperation();
        $this->assertEquals($expectedResponse, $response);
        $actualRequests = $transport->popReceivedCalls();
        $this->assertSame(1, count($actualRequests));
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/UpdateOperation', $actualFuncCall);
     ...
     * @test
     */
    public function updateOperationExceptionTest()
    {
        $transport = $this->createTransport();
        $client = $this->createClient(['transport' => $transport]);
    ...
    public function getScanConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/GetScanConfig', $actualFuncCall);
    ...
    public function listScanConfigsTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/ListScanConfigs', $actualFuncCall);
    ...
    public function updateScanConfigTest()
    {
        ...
        $actualFuncCall = $actualRequests[0]->getFuncCall();
        $actualRequestObject = $actualRequests[0]->getRequestObject();
        $this->assertSame('/google.devtools.containeranalysis.v1alpha1.ContainerAnalysis/UpdateScanConfig', $actualFuncCall);
