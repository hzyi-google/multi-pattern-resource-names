...
namespace Google\Devtools\Containeranalysis\V1alpha1\AliasContext;
 ...
 *
 * Protobuf type <code>google.devtools.containeranalysis.v1alpha1.AliasContext.Kind</code>
 */
class Kind
{
    /**
...
class_alias(Kind::class, \Google\Devtools\Containeranalysis\V1alpha1\AliasContext_Kind::class);
