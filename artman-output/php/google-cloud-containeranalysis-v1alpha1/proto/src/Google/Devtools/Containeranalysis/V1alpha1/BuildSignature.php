 ...
 *
 * Generated from protobuf message <code>google.devtools.containeranalysis.v1alpha1.BuildSignature</code>
 */
final class BuildSignature extends \Google\Protobuf\Internal\Message
{
     ...
     * `key_id`
     *
     * Generated from protobuf field <code>.google.devtools.containeranalysis.v1alpha1.BuildSignature.KeyType key_type = 4;</code>
     */
    private $key_type = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Devtools\Containeranalysis\V1alpha1\BuildSignature_KeyType::class);
        $this->key_type = $var;
