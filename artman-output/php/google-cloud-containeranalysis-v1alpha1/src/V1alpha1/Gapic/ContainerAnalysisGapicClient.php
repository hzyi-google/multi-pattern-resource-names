...
use Google\Devtools\Containeranalysis\V1alpha1\Note\Kind;
...
class ContainerAnalysisGapicClient
{
     ...
     *          For allowed values, use constants defined on {@see \Google\Devtools\Containeranalysis\V1alpha1\Note\Kind}
     *     @type RetrySettings|array $retrySettings
     *          Retry settings to use for this call. Can be a
     *          {@see Google\ApiCore\RetrySettings} object, or an associative array
     *          of retry settings parameters. See the documentation on
     ...
     * $containerAnalysisClient = new ContainerAnalysisClient();
     * try {
     *     $response = $containerAnalysisClient->createOperation();
     * } finally {
     *     $containerAnalysisClient->close();
     * }
     * ```
     ...
     * @experimental
     */
    public function createOperation(array $optionalArgs = [])
    {
        $request = new CreateOperationRequest();
     ...
     * $containerAnalysisClient = new ContainerAnalysisClient();
     * try {
     *     $response = $containerAnalysisClient->updateOperation();
     * } finally {
     *     $containerAnalysisClient->close();
     * }
     * ```
     ...
     * @experimental
     */
    public function updateOperation(array $optionalArgs = [])
    {
        $request = new UpdateOperationRequest();
        if (isset($optionalArgs['name'])) {
            $request->setName($optionalArgs['name']);
        }
        if (isset($optionalArgs['operation'])) {
     ...
     * $containerAnalysisClient = new ContainerAnalysisClient();
     * try {
     *     $response = $containerAnalysisClient->getScanConfig();
     * } finally {
     *     $containerAnalysisClient->close();
     * }
     * ```
     ...
     * $containerAnalysisClient = new ContainerAnalysisClient();
     * try {
     *     $response = $containerAnalysisClient->listScanConfigs();
     * } finally {
     *     $containerAnalysisClient->close();
     * }
     * ```
     ...
     * }
     *
     * @return \Google\Devtools\Containeranalysis\V1alpha1\ListScanConfigsResponse
     *
     * @throws ApiException if the remote call fails
     * @experimental
     */
     ...
     * $containerAnalysisClient = new ContainerAnalysisClient();
     * try {
     *     $response = $containerAnalysisClient->updateScanConfig();
     * } finally {
     *     $containerAnalysisClient->close();
     * }
     * ```
