...
class BuildProvenance extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .grafeas.v1beta1.provenance.Command commands = 3;</code>
     */
    private $commands;
    /**
     * Output of the build.
     *
     * Generated from protobuf field <code>repeated .grafeas.v1beta1.provenance.Artifact built_artifacts = 4;</code>
     */
     ...
     *           Commands requested by the build.
     *     @type \Grafeas\V1beta1\Provenance\Artifact[]|\Google\Protobuf\Internal\RepeatedField $built_artifacts
     *           Output of the build.
     ...
     *           URI where any logs for this provenance were written.
     *     @type \Grafeas\V1beta1\Provenance\Source $source_provenance
     *           Details of the Source input to the build.
     ...
     *
     * Generated from protobuf field <code>repeated .grafeas.v1beta1.provenance.Command commands = 3;</code>
     * @param \Grafeas\V1beta1\Provenance\Command[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCommands($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Grafeas\V1beta1\Provenance\Command::class);
        $this->commands = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .grafeas.v1beta1.provenance.Artifact built_artifacts = 4;</code>
     * @param \Grafeas\V1beta1\Provenance\Artifact[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBuiltArtifacts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Grafeas\V1beta1\Provenance\Artifact::class);
     ...
     *
     * Generated from protobuf field <code>.grafeas.v1beta1.provenance.Source source_provenance = 10;</code>
     * @param \Grafeas\V1beta1\Provenance\Source $var
     * @return $this
     */
    public function setSourceProvenance($var)
    {
        GPBUtil::checkMessage($var, \Grafeas\V1beta1\Provenance\Source::class);
