 ...
 * https://github.com/google/googleapis/blob/master/google/cloud/talent/v4beta1/company_service.proto
...
use Google\Cloud\Talent\V4beta1\CompanyServiceGrpcClient;
...
class CompanyServiceGapicClient
{
    ...
    {
        if (self::$companyWithoutTenantNameTemplate == null) {
