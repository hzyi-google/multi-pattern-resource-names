...
public class ImportJobName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/keyRings/{key_ring}/importJobs/{import_job}");
  ...
  public static ImportJobName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "ImportJobName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("key_ring"), matchMap.get("import_job"));
  }
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "location", location, "key_ring", keyRing, "import_job", importJob);
  }
