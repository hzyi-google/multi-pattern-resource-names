...
public class CompanyWithTenantName extends CompanyName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/tenants/{tenant}/companies/{company}");
  ...
  public static CompanyWithTenantName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "CompanyWithTenantName.parse: formattedString not in valid format");
