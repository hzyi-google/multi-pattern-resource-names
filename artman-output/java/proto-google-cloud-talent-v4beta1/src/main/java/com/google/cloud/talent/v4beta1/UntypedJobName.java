...
public class UntypedJobName extends JobName {
  ...
  public static List<UntypedJobName> parseList(List<String> formattedStrings) {
    List<UntypedJobName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<UntypedJobName> values) {
