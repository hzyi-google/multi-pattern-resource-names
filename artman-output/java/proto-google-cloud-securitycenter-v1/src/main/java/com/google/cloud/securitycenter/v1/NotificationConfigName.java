...
public class NotificationConfigName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("organizations/{organization}/notificationConfigs/{notification_config}");
  ...
  public static NotificationConfigName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "NotificationConfigName.parse: formattedString not in valid format");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("organization", organization, "notification_config", notificationConfig);
  }
