...
public class BillingAccountLocationName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("billingAccounts/{billing_account}/locations/{location}");
  ...
  public static BillingAccountLocationName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "BillingAccountLocationName.parse: formattedString not in valid format");
