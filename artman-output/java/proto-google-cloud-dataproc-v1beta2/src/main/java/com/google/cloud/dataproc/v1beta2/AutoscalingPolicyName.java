...
public class AutoscalingPolicyName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/regions/{region}/autoscalingPolicies/{autoscaling_policy}");
  ...
  public static AutoscalingPolicyName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "AutoscalingPolicyName.parse: formattedString not in valid format");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "region", region, "autoscaling_policy", autoscalingPolicy);
  }
