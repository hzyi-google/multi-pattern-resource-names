...
public class ContainerAnalysisStubSettings extends StubSettings<ContainerAnalysisStubSettings> {
  ...
  private final UnaryCallSettings<CreateOperationRequest, Operation> createOperationSettings;
  private final UnaryCallSettings<UpdateOperationRequest, Operation> updateOperationSettings;
  private final UnaryCallSettings<GetScanConfigRequest, ScanConfig> getScanConfigSettings;
  private final UnaryCallSettings<ListScanConfigsRequest, ListScanConfigsResponse>
  ...
  /** Returns the object with the settings used for calls to createOperation. */
  public UnaryCallSettings<CreateOperationRequest, Operation> createOperationSettings() {
    return createOperationSettings;
  }

  /** Returns the object with the settings used for calls to updateOperation. */
  public UnaryCallSettings<UpdateOperationRequest, Operation> updateOperationSettings() {
  ...
  public UnaryCallSettings<ListScanConfigsRequest, ListScanConfigsResponse>
      listScanConfigsSettings() {
  ...
  protected ContainerAnalysisStubSettings(Builder settingsBuilder) throws IOException {
    ...
    createOperationSettings = settingsBuilder.createOperationSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<ContainerAnalysisStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<TestIamPermissionsRequest, TestIamPermissionsResponse>
        testIamPermissionsSettings;
    private final UnaryCallSettings.Builder<CreateOperationRequest, Operation>
        createOperationSettings;
    private final UnaryCallSettings.Builder<UpdateOperationRequest, Operation>
        updateOperationSettings;
    private final UnaryCallSettings.Builder<GetScanConfigRequest, ScanConfig> getScanConfigSettings;
    private final UnaryCallSettings.Builder<ListScanConfigsRequest, ListScanConfigsResponse>
        listScanConfigsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      createOperationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      updateOperationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      getScanConfigSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      listScanConfigsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(ContainerAnalysisStubSettings settings) {
      ...
      createOperationSettings = settings.createOperationSettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to createOperation. */
    public UnaryCallSettings.Builder<CreateOperationRequest, Operation> createOperationSettings() {
      return createOperationSettings;
    }

    /** Returns the builder for the settings used for calls to updateOperation. */
    public UnaryCallSettings.Builder<UpdateOperationRequest, Operation> updateOperationSettings() {
      return updateOperationSettings;
    }
    ...
    public UnaryCallSettings.Builder<ListScanConfigsRequest, ListScanConfigsResponse>
        listScanConfigsSettings() {
      return listScanConfigsSettings;
    }
