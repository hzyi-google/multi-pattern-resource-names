...
public class ContainerAnalysisClient implements BackgroundResource {
   ...
   *
   * @deprecated Use the {@link NoteName} class instead.
   */
  @Deprecated
   ...
   *
   * @deprecated Use the {@link OccurrenceName} class instead.
   */
  @Deprecated
   ...
   * <pre><code>
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   CreateOperationRequest request = CreateOperationRequest.newBuilder().build();
   *   Operation response = containerAnalysisClient.createOperation(request);
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation createOperation(CreateOperationRequest request) {
    return createOperationCallable().call(request);
  }
   ...
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   CreateOperationRequest request = CreateOperationRequest.newBuilder().build();
   *   ApiFuture&lt;Operation&gt; future = containerAnalysisClient.createOperationCallable().futureCall(request);
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   */
  public final UnaryCallable<CreateOperationRequest, Operation> createOperationCallable() {
    return stub.createOperationCallable();
  }
   ...
   * <pre><code>
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   UpdateOperationRequest request = UpdateOperationRequest.newBuilder().build();
   *   Operation response = containerAnalysisClient.updateOperation(request);
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Operation updateOperation(UpdateOperationRequest request) {
    return updateOperationCallable().call(request);
  }
   ...
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   UpdateOperationRequest request = UpdateOperationRequest.newBuilder().build();
   *   ApiFuture&lt;Operation&gt; future = containerAnalysisClient.updateOperationCallable().futureCall(request);
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   */
  public final UnaryCallable<UpdateOperationRequest, Operation> updateOperationCallable() {
   ...
   *   ScanConfig response = containerAnalysisClient.getScanConfig(request);
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   GetScanConfigRequest request = GetScanConfigRequest.newBuilder().build();
   *   ApiFuture&lt;ScanConfig&gt; future = containerAnalysisClient.getScanConfigCallable().futureCall(request);
   *   // Do something
   ...
   *   ListScanConfigsResponse response = containerAnalysisClient.listScanConfigs(request);
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListScanConfigsResponse listScanConfigs(ListScanConfigsRequest request) {
    return listScanConfigsCallable().call(request);
  }
   ...
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   ListScanConfigsRequest request = ListScanConfigsRequest.newBuilder().build();
   *   ApiFuture&lt;ListScanConfigsResponse&gt; future = containerAnalysisClient.listScanConfigsCallable().futureCall(request);
   *   // Do something
   *   ListScanConfigsResponse response = future.get();
   * }
   * </code></pre>
   */
   ...
   *   ScanConfig response = containerAnalysisClient.updateScanConfig(request);
   * }
   * </code></pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   * try (ContainerAnalysisClient containerAnalysisClient = ContainerAnalysisClient.create()) {
   *   UpdateScanConfigRequest request = UpdateScanConfigRequest.newBuilder().build();
   *   ApiFuture&lt;ScanConfig&gt; future = containerAnalysisClient.updateScanConfigCallable().futureCall(request);
   *   // Do something
   *   ScanConfig response = future.get();
   * }
   * </code></pre>
