...
public class ContainerAnalysisSettings extends ClientSettings<ContainerAnalysisSettings> {
  ...
  public UnaryCallSettings<CreateOperationRequest, Operation> createOperationSettings() {
    return ((ContainerAnalysisStubSettings) getStubSettings()).createOperationSettings();
  }
  ...
  public UnaryCallSettings<UpdateOperationRequest, Operation> updateOperationSettings() {
    return ((ContainerAnalysisStubSettings) getStubSettings()).updateOperationSettings();
  }
  ...
  public UnaryCallSettings<GetScanConfigRequest, ScanConfig> getScanConfigSettings() {
    return ((ContainerAnalysisStubSettings) getStubSettings()).getScanConfigSettings();
  }
  ...
  public UnaryCallSettings<ListScanConfigsRequest, ListScanConfigsResponse>
    ...
    return ((ContainerAnalysisStubSettings) getStubSettings()).listScanConfigsSettings();
  }
  ...
  public UnaryCallSettings<UpdateScanConfigRequest, ScanConfig> updateScanConfigSettings() {
    return ((ContainerAnalysisStubSettings) getStubSettings()).updateScanConfigSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<ContainerAnalysisSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<CreateOperationRequest, Operation> createOperationSettings() {
      return getStubSettingsBuilder().createOperationSettings();
    }
