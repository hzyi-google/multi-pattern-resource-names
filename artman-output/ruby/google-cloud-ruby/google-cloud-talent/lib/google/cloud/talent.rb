...
module Google
  module Cloud
    ...
    ##
    # # Ruby Client for Cloud Talent Solution API ([Alpha](https://github.com/GoogleCloudPlatform/google-cloud-ruby#versioning))
    #
      ...
      module Company
        ...
        def self.new(*args, version: :v4beta1, **kwargs)
          ...
          version_module = Google::Cloud::Talent
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Talent.const_get(version_module)::Company.new(*args, **kwargs)
        end
      end
      ...
      module Job
        ...
        def self.new(*args, version: :v4beta1, **kwargs)
          ...
          version_module = Google::Cloud::Talent
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Talent.const_get(version_module)::Job.new(*args, **kwargs)
        end
      end
      ...
      module Profile
        ...
        def self.new(*args, version: :v4beta1, **kwargs)
          ...
          version_module = Google::Cloud::Talent
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Talent.const_get(version_module)::Profile.new(*args, **kwargs)
        end
      end
      ...
      module Tenant
        ...
        def self.new(*args, version: :v4beta1, **kwargs)
          ...
          version_module = Google::Cloud::Talent
            ...
            .select {|sym| sym.to_s.downcase == version.to_s.downcase}
            .first
          Google::Cloud::Talent.const_get(version_module)::Tenant.new(*args, **kwargs)
        end
      end
    end
  end
