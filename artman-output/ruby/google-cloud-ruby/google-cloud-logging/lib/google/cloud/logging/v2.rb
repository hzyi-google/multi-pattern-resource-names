      ...
      module V2
        ...
        module Config
          ...
          def self.new \
            ...
            Google::Cloud::Logging::V2::ConfigServiceV2Client.new(**kwargs)
          end
        end
        ...
        module Logging
          ...
          def self.new \
            ...
            Google::Cloud::Logging::V2::LoggingServiceV2Client.new(**kwargs)
          end
        end
        ...
        module Metrics
          ...
          def self.new \
            ...
            Google::Cloud::Logging::V2::MetricsServiceV2Client.new(**kwargs)
          end
        end
      end
    end
