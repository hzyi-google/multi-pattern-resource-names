...
class MockMetricsServiceV2Credentials_v2 < Google::Cloud::Logging::V2::Credentials
...
describe Google::Cloud::Logging::V2::MetricsServiceV2Client do
  ...
  describe 'list_log_metrics' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Logging::V2::MetricsServiceV2Client#list_log_metrics."
    ...
    it 'invokes list_log_metrics without error' do
      ...
      mock_stub = MockGrpcClientStub_v2.new(:list_log_metrics, mock_method)

      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials_v2.new("list_log_metrics")
  ...
  describe 'get_log_metric' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Logging::V2::MetricsServiceV2Client#get_log_metric."
    ...
    it 'invokes get_log_metric without error' do
      ...
      mock_stub = MockGrpcClientStub_v2.new(:get_log_metric, mock_method)

      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials_v2.new("get_log_metric")
      ...
      Google::Logging::V2::MetricsServiceV2::Stub.stub(:new, mock_stub) do
        Google::Cloud::Logging::V2::Credentials.stub(:default, mock_credentials) do
          ...
          client.get_log_metric(formatted_metric_name) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
  ...
  describe 'create_log_metric' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Logging::V2::MetricsServiceV2Client#create_log_metric."
    ...
    it 'invokes create_log_metric without error' do
      ...
      mock_stub = MockGrpcClientStub_v2.new(:create_log_metric, mock_method)

      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials_v2.new("create_log_metric")
      ...
      Google::Logging::V2::MetricsServiceV2::Stub.stub(:new, mock_stub) do
        Google::Cloud::Logging::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.create_log_metric(formatted_parent, metric) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
  ...
  describe 'update_log_metric' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Logging::V2::MetricsServiceV2Client#update_log_metric."
    ...
    it 'invokes update_log_metric without error' do
      ...
      mock_stub = MockGrpcClientStub_v2.new(:update_log_metric, mock_method)

      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials_v2.new("update_log_metric")
      ...
      Google::Logging::V2::MetricsServiceV2::Stub.stub(:new, mock_stub) do
        Google::Cloud::Logging::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.update_log_metric(formatted_metric_name, metric) do |response, operation|
            # Verify the response
            assert_equal(expected_response, response)
            refute_nil(operation)
          end
  ...
  describe 'delete_log_metric' do
    custom_error = CustomTestError_v2.new "Custom test error for Google::Cloud::Logging::V2::MetricsServiceV2Client#delete_log_metric."
    ...
    it 'invokes delete_log_metric without error' do
      ...
      mock_stub = MockGrpcClientStub_v2.new(:delete_log_metric, mock_method)

      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials_v2.new("delete_log_metric")
      ...
      Google::Logging::V2::MetricsServiceV2::Stub.stub(:new, mock_stub) do
        Google::Cloud::Logging::V2::Credentials.stub(:default, mock_credentials) do
          ...
          # Call method with block
          client.delete_log_metric(formatted_metric_name) do |response, operation|
            # Verify the response
            assert_nil(response)
            refute_nil(operation)
          end
