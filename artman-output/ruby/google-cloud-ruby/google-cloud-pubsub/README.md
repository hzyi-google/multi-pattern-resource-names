...
### Installation
```
$ gem install google-cloud-pub_sub
```
...
### Next Steps
- Read the [Client Library Documentation][] for Cloud Pub/Sub API
...
[Client Library Documentation]: https://googlecloudplatform.github.io/google-cloud-ruby/#/docs/google-cloud-pub_sub/latest/google/pubsub/v1
