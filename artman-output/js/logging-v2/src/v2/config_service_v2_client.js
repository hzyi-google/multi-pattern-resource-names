...
class ConfigServiceV2Client {
   ...
   * @returns {String} - A string representing the billing_account.
   */
  matchBillingAccountFromBillingAccountLocationName(billingAccountLocationName) {
    return this._pathTemplates.billingAccountLocationPathTemplate
      .match(billingAccountLocationName)
      .billing_account;
  }
  ...
  matchFolderFromFolderLocationName(folderLocationName) {
    return this._pathTemplates.folderLocationPathTemplate
      .match(folderLocationName)
      .folder;
  }
  ...
  matchOrganizationFromOrganizationLocationName(organizationLocationName) {
    return this._pathTemplates.organizationLocationPathTemplate
      .match(organizationLocationName)
      .organization;
  }
