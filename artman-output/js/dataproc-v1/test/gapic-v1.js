...
describe('ClusterControllerClient', () => {
  ...
  it('should create a client with gRPC fallback', () => {
    const client = new dataprocModule.v1.ClusterControllerClient({fallback: true});
    assert(client);
  });
...
describe('WorkflowTemplateServiceClient', () => {
  it('has servicePath', () => {
    const servicePath = dataprocModule.v1.WorkflowTemplateServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = dataprocModule.v1.WorkflowTemplateServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  it('should create a client with gRPC fallback', () => {
    const client = new dataprocModule.v1.WorkflowTemplateServiceClient({fallback: true});
    assert(client);
  });
...
describe('AutoscalingPolicyServiceClient', () => {
  it('has servicePath', () => {
    const servicePath = dataprocModule.v1.AutoscalingPolicyServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = dataprocModule.v1.AutoscalingPolicyServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port = dataprocModule.v1.AutoscalingPolicyServiceClient.port;
    assert(port);
    assert(typeof port === 'number');
  });

  it('should create a client with no options', () => {
    const client = new dataprocModule.v1.AutoscalingPolicyServiceClient();
    assert(client);
  });

  it('should create a client with gRPC fallback', () => {
    const client = new dataprocModule.v1.AutoscalingPolicyServiceClient({fallback: true});
    assert(client);
  });
