...
class WorkflowTemplateServiceClient {
  ...
  constructor(opts) {
    ...
    const workflowTemplateServiceStub = gaxGrpc.createStub(
      opts.fallback ?
        protos.lookupService('google.cloud.dataproc.v1beta2.WorkflowTemplateService') :
  ...
  matchProjectFromWorkflowTemplateName(workflowTemplateName) {
    return this._pathTemplates.workflowTemplatePathTemplate
      .match(workflowTemplateName)
      .project;
  }
