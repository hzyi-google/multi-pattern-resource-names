...
class AutoscalingPolicyServiceClient {
  ...
  constructor(opts) {
    ...
    const autoscalingPolicyServiceStub = gaxGrpc.createStub(
      opts.fallback ?
        protos.lookupService('google.cloud.dataproc.v1beta2.AutoscalingPolicyService') :
  ...
  matchProjectFromAutoscalingPolicyName(autoscalingPolicyName) {
    return this._pathTemplates.autoscalingPolicyPathTemplate
      .match(autoscalingPolicyName)
      .project;
  }
  ...
  matchProjectFromRegionName(regionName) {
    return this._pathTemplates.regionPathTemplate
      .match(regionName)
      .project;
  }
